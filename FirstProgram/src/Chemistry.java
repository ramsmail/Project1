...
public class Chemistry {
  public static void main(String args[]) {
    ...
    if(chemWord != null && chemWord.equalsIgnoreCase(inputWord))
  ...
  public static String spellWord(String word, String[] elements) {
    ...
    for (short i = 0; i < word.length(); i++){
      ...
      catWord = catWord+ String.valueOf(word.charAt(i));
      String getWord = checkInElements(catWord, elements);
      if (getWord != null){
        speltWord = speltWord + catWord;
        catWord="";
      }
  ...
  public static String checkInElements(String catWord, String[] elements){

    for (short i = 0; i < elements.length; i++){
      if (catWord.equalsIgnoreCase(elements[i])){
        return catWord;
      }
    }
    return "";
